...
//  console.log(data)
  ...
  //   if (data.length) {
  //     setAllEvents(appointments.find((appointment) => appointment._id === id));
  //   }
  // }, [appointments]);
  ...
  const handleAddEvent = async (event) => {
    ...
    setAllEvents([...allEvents, newEvent, data]);
  };
  ...
  return (
    <div>
      ...
      <div className="appointment-scheduler">
        <form action="/action_page.php">
          ...
          <div>
            ...
            >
              ...
              <option value="Additional Color">
                Additional Color $10 Each
              </option>
              <option value="Color Correction">
                Color Correction Starts at $100
              </option>
            </select>
          </div>
          <div>
        ...
        <p>
          {error && (
            <span className="ml-2">Please log in or create an account</span>
          )}
        </p>
      </div>
      ...
      <Calendar
        ...
        className="calendar"
        startTime={allEvents.start}
        appointmentType={allEvents.title}
      />
    </div>
  );
};
